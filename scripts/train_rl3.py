"""The learned ceiling on the board that passed the contract.
...
for carry, lbl in ((True, '이월 있음'), (False, '이월 없음')):
    ...
    json.dump(out, open('data_rl3.json', 'w'), indent=1)
print(f"\n  참고 · 호가판만 830 · 원장(기억O) 871 · 원장(기억X) 793 · 프리미엄 120")
