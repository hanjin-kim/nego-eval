...
- **품목 하나, 라운드당 한 개.** 바스켓도, 리드타임도, 품질 등급도, 최소주문수량도
  없습니다.
- **실패는 외생이고 그 확률이 공시됩니다.** 현실에서는 둘 다 아닙니다. 신뢰도는
...
- **지평이 알려져 있습니다.** 에이전트에게 남은 라운드 수를 알려주는데, 이는 종반
  행동을 열린 관계에서는 일어나지 않는 방식으로 날카롭게 만듭니다.
...
학습자에게요. 통제 변량이 이미 풀린 신호의 85%를 걷어냅니다.
